...
require batteries from git "https://github.com/leanprover-community/batteries.git" @ "v4.8.0"
require aesop from git "https://github.com/leanprover-community/aesop" @ "v4.8.0"
